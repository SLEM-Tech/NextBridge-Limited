...
import computerAccessoriesImg from "./computerAccessoriesBg.jpg";
import computerMaintenanceImg from "./computerMaintenanceBg.jpg";
import computerHardwareImg from "./computerHardwareBg.jpg";
import sellingItemsImg from "./bestSellingQualityBg.png";
import gameEngineImg from "./gameEngines.png";
import playstationImg from "./playstation5.png";
import virtualControllerImg from "./virtualController.png";
import gameLayerBg from "./layer.png";
import a_man_writing_with_smile from "./a_man_smiling_writing.png";

export {
  a_man_writing_with_smile,
  gameLayerBg,
