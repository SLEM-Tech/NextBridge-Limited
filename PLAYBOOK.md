# NextBridge Limited — Developer Playbook
...
```bash
git clone https://github.com/SLEM-Tech/nextbridge-limited.git
cd nextbridge-limited
...
Creates all database tables with the `nextBridge_` prefix. Source file: `src/lib/schema.sql`.

Tables created:

- `nextBridge_users`
- `nextBridge_categories`
- `nextBridge_products`
- `nextBridge_product_images`
- `nextBridge_product_categories`
- `nextBridge_product_attributes`
- `nextBridge_orders`
- `nextBridge_order_items`
- `nextBridge_banners`
- `nextBridge_global_settings`
...
```
GET http://localhost:3000/api/admin/bootstrap?secret=nextBridge-admin-2024
```
...
curl "http://localhost:3000/api/admin/bootstrap?secret=nextBridge-admin-2024"
```
...
| `http://localhost:3000/api/admin/bootstrap?secret=nextBridge-admin-2024` | Create super admin account (step 3)        |
