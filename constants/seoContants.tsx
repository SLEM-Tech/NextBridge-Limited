...
export const SITE_NAME = "NextBridge Limited";
export const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL || "https://nextBridge.com"; // Update with actual URL
export const TWITTER_HANDLE = "@nextBridge";
...
export const SEODATA: Record<string, SEOConfig> = {
  default: {
    ...
    description:
      "NextBridge Limited Limited provides cutting-edge software development, AI integration, and digital transformation strategies to scale modern enterprises.",
    keywords: [
      "NextBridge Limited Limited",
  ...
  home: {
    ...
    description:
      "Innovate and grow with NextBridge Limited Limited. We build high-performance digital products, from mobile apps to enterprise AI systems, tailored to your business needs.",
    keywords: [
  ...
  login: {
    ...
    description:
      "Access your NextBridge Limited Limited client dashboard to track project progress, manage subscriptions, and collaborate with your dev team.",
    keywords: [
      "Client login",
      "Project tracking portal",
      "NextBridge Limited Limited dashboard access",
    ],
  },
  register: {
    title: `Partner with Us | Join ${SITE_NAME}`,
    description:
      "Create an account to start your project journey with NextBridge Limited Limited Digital Innovations and access premium tech resources.",
    keywords: [
      "Get started with NextBridge Limited Limited",
      "Project onboarding",
      "Digital partnership",
    ],
  },
