...
const AuthModal: React.FC<ModalProps> = ({
	...
	return (
		...
		>
			...
			<div className='bg-surface border border-brand-border flex flex-col w-full md:w-[35rem] gap-2 md:gap-4 px-2 sm:px-0 justify-center items-center rounded-2xl drop-shadow-lg relative'>
				<IoCloseSharp
					className='text-white absolute right-4 top-4 hover:scale-105 transition-[.4] text-xl cursor-pointer'
