        ...
        <>
          {CategoryProducts?.length > 0 && (
            <div className="w-full px-2 space-y-4">
              <Back />
              <div className="flex items-end justify-between gap-6 border-b border-brand-border pb-6">
                <div className="max-w-xl">
                  <p className="text-[11px] uppercase tracking-[0.3em] text-primary-100 font-semibold mb-3">
                    Collection
                  </p>
                  <h4
                    ...
                    className="font-serif italic text-3xl sm:text-4xl font-bold text-white"
                  />
                </div>
                <span className="shrink-0 text-xs font-semibold uppercase tracking-[0.22em] text-ink-soft">
          ...
          {CategoryProducts?.length > 0 && (
            <div className="py-3 sm:px-7 w-full min-h-[400px]">
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-5 lg:gap-6 px-2 sm:px-0">
                {CategoryProducts?.length > 0 &&
          ...
          {CategoryProducts?.length === 0 && (
            <div className="flex w-full flex-col gap-3 items-center justify-center min-h-[40vh]">
              <h4 className="font-medium text-base text-ink-soft">
                No products in this category
              </h4>
              <h4 className="font-serif italic text-2xl slg:text-3xl font-bold text-white">
                Check back later
              </h4>
            </div>
          )}
