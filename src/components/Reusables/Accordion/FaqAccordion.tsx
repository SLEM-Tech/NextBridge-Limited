...
const FaqAccordionItem: React.FC<FaqAccordionItemProps> = ({
  ...
  return (
    <div className="text-white bg-surface border border-brand-border rounded-lg transition">
      <div
        className="flex justify-between items-center py-5 px-4 sm:px-8 text-xs xs:text-sm sm:text-base font-[500] cursor-pointer"
      ...
      <div
        className="px-4 sm:px-8 text-sm sm:text-base text-start text-ink-soft"
        style={{
...
const faqItems: FaqAccordionItemProps[] = [
  {
    id: 1,
    title: "How does the NextBridge Limited importation process work?",
    description:
...

  {
    ...
    description:
      "After making a transfer to the NextBridge Limited corporate account, simply upload your transaction receipt and Session ID/Reference via the 'Verify Payment' button on your order page for instant admin reconciliation.",
  },
  ...
  },
  {
    ...
    description:
      "Yes. All electronic and mechanical products procured through NextBridge Limited carry a standard manufacturer’s warranty, which we help you facilitate in the event of a technical issue.",
  },
  {
    id: 8,
    title: "Is there a benefit to paying off my balance early?",
    description:
      "Yes, NextBridge Limited rewards financial discipline. Customers who complete their payments ahead of schedule may be eligible for discounts on future shipping fees or interest-free credit extensions.",
  },
  {
    id: 9,
