...
const SubCategoryCard = ({ id, image, name }: SubCategoryCardProps) => {
  ...
  return (
    <Link
      ...
      className={`flex flex-col items-center group cursor-pointer rounded-lg bg-white border-2 border-gray-100 hover:border-primary-100/50 transition-all duration-300 overflow-hidden shadow-sm hover:shadow-md w-full h-fit ${
