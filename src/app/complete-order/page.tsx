...
const Page = () => {
  ...
  return (
    <AppLayout className="px-4 sm:px-8">
      <main className="bg-white flex flex-col items-center relative justify-center w-full sm:py-10 mt-28 sm:mt-40 xl:mt-44 xl:py-5 mx-auto max-w-[1156px] min-h-[50vh] mb-20 px-4 sm:px-8 lg:px-2">
